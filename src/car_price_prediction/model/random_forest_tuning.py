...
from car_price_prediction.utils import load_or_save_dataset, load_or_save_model,get_X_and_y
...
def get_grid_best_params(data = load_or_save_dataset.get_processed_dataset()):
    ...
    grid = GridSearchCV(forest,params_grid,scoring="neg_mean_absolute_error",cv=3)
