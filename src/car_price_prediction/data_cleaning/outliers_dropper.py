...
def drop_max_price_min_year(df):
    ...
    cars_to_drop = cars_till_2008[cars_till_2008[Car.PRICE]
                                  > Car.MAX_MONEY_FOR_MIN_YEAR_2008]
...
def make_mileage_outliers_nan(df):
    ...
    cars_to_drop = cars_till_2010[cars_till_2010[Car.MILEAGE]
                                  < Car.MIN_YEAR_FOR_MIN_MILEAGE]
